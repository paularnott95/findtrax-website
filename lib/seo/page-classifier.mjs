export function classifyUrlPattern(url = '') {
  ...
  if (path === '/pages/top-missing-locations') return pattern('legacy-top-missing-locations', 'templates/page.top-missing-locations.json', 'redirect-or-canonicalize-to-country-intelligence')
