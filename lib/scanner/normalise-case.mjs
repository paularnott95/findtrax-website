...
export function normaliseCase(sourceCase, source = {}) {
  ...
  return {
    ...
    photoVisibility: sourceCase.photoVisibility || 'source-policy',
    ...
    tags: Array.from(new Set(['scanner-imported', 'public-source', `country:${location.countryName}`, `country-code:${location.countryCode}`, `country-slug:${location.countrySlug}`, `location:${location.locationSlug}`, status])),
