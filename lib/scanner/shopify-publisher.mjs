...
function articleMetafields(record) {
  ...
  if (record.publicLatitude !== undefined && record.publicLatitude !== null) fields.push({ key: 'location_lat', type: 'number_decimal', value: String(record.publicLatitude) })
  if (record.publicLongitude !== undefined && record.publicLongitude !== null) fields.push({ key: 'location_lng', type: 'number_decimal', value: String(record.publicLongitude) })
  return fields
}
