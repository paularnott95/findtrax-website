...
function scannerPage() {
  return layout('Scanner | Missing Alerts', 'Scanner status, configured source logic and protected import workflow.', `<section class="section"><div class="container">${sectionHead('Scanner', 'Verified public case import status.')}<div class="card"><button class="btn dark" type="button">Scan button requires dashboard secret</button><p>Live trusted source feeds are not connected yet. Scanner fixtures and seeded cases are available for validation only.</p><p>Country selector: United Kingdom, Ireland, Australia, New Zealand, United States, Canada.</p><p>Source selector: approved official/public feeds only when configured.</p><table class="scan-table"><tr><th>Status</th><td>Disabled - source feeds not connected</td></tr><tr><th>Live imports</th><td>0</td></tr><tr><th>Seeded public cases</th><td>${active.length}</td></tr><tr><th>Skipped rules</th><td>Found-safe, duplicate and unverified records are skipped.</td></tr></table></div></div></section>`, '/scanner')
}
