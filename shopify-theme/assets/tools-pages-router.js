(function () {
  ...
  function countdownHtml() {
    return [
      '<div class="ma-tools-countdown" data-ma-tools-countdown data-target="2026-07-01T00:00:00+01:00">',
      '<div class="ma-tools-countdown__item"><span class="ma-tools-countdown__value" data-countdown-days>000</span><span class="ma-tools-countdown__label">Days</span></div>',
      '<div class="ma-tools-countdown__item"><span class="ma-tools-countdown__value" data-countdown-hours>00</span><span class="ma-tools-countdown__label">Hours</span></div>',
      '<div class="ma-tools-countdown__item"><span class="ma-tools-countdown__value" data-countdown-minutes>00</span><span class="ma-tools-countdown__label">Minutes</span></div>',
      '<div class="ma-tools-countdown__item"><span class="ma-tools-countdown__value" data-countdown-seconds>00</span><span class="ma-tools-countdown__label">Seconds</span></div>',
      '</div>'
    ].join('');
  }
  ...
  function signupHtml(product) {
    return [
      '<div id="tool-signup-' + escapeHtml(product.key) + '" class="ma-tools-page__launch">',
      '<div class="ma-tools-page__launch-title">COMING ON 1ST JULY 2026</div>',
      countdownHtml(),
      '<h2>SIGN UP FOR RELEASE DAY</h2>',
      '<p class="ma-tools-page__notice">Be first to know when this tool goes live.</p>',
      '<form method="post" action="/contact#tool-signup-' + escapeHtml(product.key) + '" class="ma-tools-page__form">',
      '<input type="hidden" name="form_type" value="customer">',
      '<input type="hidden" name="utf8" value="✓">',
      '<input type="hidden" name="contact[tags]" value="tool-release-day,' + escapeHtml(product.key) + '">',
      '<input type="email" name="contact[email]" required aria-label="Email address" placeholder="Email address">',
      '<button type="submit">SIGN UP FOR RELEASE DAY</button>',
      '</form>',
      '</div>'
    ].join('');
  }
  ...
  function pageHtml(product) {
    ...
    return [
      '<section class="ma-tools-page" data-ma-tools-page="' + escapeHtml(product.key) + '">',
      '<div class="ma-tools-page__inner">',
      '<div class="ma-tools-page__hero">',
      '<div><span class="ma-tools-page__eyebrow">Missing Alerts tool</span>',
      '<h1>' + escapeHtml(product.label) + '</h1>',
      '<p class="ma-tools-page__intro">' + escapeHtml(product.intro) + '</p>',
      '<p class="ma-tools-page__copy">' + escapeHtml(product.positioning) + '</p>',
      '<div class="ma-tools-page__actions"><a class="ma-tools-page__button" href="#tool-signup-' + escapeHtml(product.key) + '">SIGN UP FOR RELEASE DAY</a><a class="ma-tools-page__button ma-tools-page__button--ghost" href="/pages/tools">All tools</a></div>',
      '</div>',
      '<div class="ma-tools-page__visual" aria-label="' + escapeHtml(product.label) + ' UI preview"><div class="ma-tools-page__window"><div class="ma-tools-page__window-top"><span>' + escapeHtml(product.label) + '</span><span>Preview</span></div><div class="ma-tools-page__preview-grid">',
      '<div class="ma-tools-page__preview-card"><strong>Case linked</strong><span>Connects work to a Missing Alerts public case.</span></div>',
      '<div class="ma-tools-page__preview-card"><strong>Reviewable</strong><span>Structured updates and notes stay easier to assess.</span></div>',
      '<div class="ma-tools-page__preview-card"><strong>Controlled visibility</strong><span>Separate public appeal fields from private working notes.</span></div>',
      '<div class="ma-tools-page__preview-card"><strong>Release ready</strong><span>Product updates begin before public launch.</span></div>',
      '</div></div></div></div>',
      '<div class="ma-tools-page__section"><h2>Core features</h2><ul class="ma-tools-page__feature-list">' + featureItems + '</ul></div>',
      '<div class="ma-tools-page__section"><h2>How it works</h2><div class="ma-tools-page__cards">' + cardsHtml(product) + '</div></div>',
      '<div class="ma-tools-page__section"><h2>Who it is for</h2><p class="ma-tools-page__intro">' + escapeHtml(product.audience) + '</p></div>',
      '<div class="ma-tools-page__section"><h2>Trust and privacy</h2><p class="ma-tools-page__intro">Each product is designed around source-backed case information, role-aware collaboration, and public/private field separation. Missing Alerts does not publish private family contact information or unverified sensitive claims in public product surfaces.</p></div>',
      signupHtml(product),
      '</div></section>'
    ].join('');
  }
  ...
  function boot() {
    ...
    if (window.MissingAlertsToolsCountdownInit) {
      window.MissingAlertsToolsCountdownInit();
    }
  }
